...
*/ -}}
{{- define "eric-oss-common-ci-pocs-epunder-test1.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-epunder-test1.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-epunder-test1.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-epunder-test1.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-epunder-test1.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
